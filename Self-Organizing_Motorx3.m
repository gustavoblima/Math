...
% %-----Vetor de Peso-----
% 
% M = [M_X(1,1) M_X(1,2);M_X(1,3) M_X(1,4);M_X(1,5) M_X(1,6);...
...
%             end
            ...
            rate(t,1)= a;
            for h = max(1,ch-r):min(3,ch+r)
                for v = max(1,cv-r):min(3,cv+r)
...
% %    
        ...
        Erro_Tr_M(:,e)= mean(Er_epoca)
        e=e+1;
        beep
        filename = ['C:\Users\Claudia\Documents\MATLAB\SOM_x3_Tr\SOM_x3_Tr', int2str(e), '.mat'];
        save(filename)
        disp('GustavoBlima')
end
